...
{
	HRESULT hr = D3DXCreateFont(pDevice3D, 20, 0, FW_NORMAL, 1, false, SHIFTJIS_CHARSET, OUT_TT_ONLY_PRECIS, ANTIALIASED_QUALITY, FF_DONTCARE, "MS ゴシック", &pFont);
	return hr;
}
...
void Direct3D::DrawSprite(Sprite& sprite,Texture & tex)
{
	...
	SpriteVertex vertex[4]=
	{
		...
		{ D3DXVECTOR3(-width / 2,-height/2,0),1.0f,D3DCOLOR_RGBA(255,255,255,alphaC),	 u/du+offsetX,		v/dv },
		{ D3DXVECTOR3(-width / 2, height/2,0),1.0f,D3DCOLOR_RGBA(255,255,255,alphaC),	 u/du+offsetX,	(v+1)/dv }
	};
